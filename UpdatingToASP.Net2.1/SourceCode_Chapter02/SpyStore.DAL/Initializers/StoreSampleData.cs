...
namespace SpyStore.DAL.Initializers
{
    public static class StoreSampleData
    {
            ...
            Order order, StoreContext context)
        {
            ...
            {
                new OrderDetail {Order = order, Product = prod1, Quantity = 3, UnitCost = (prod1 == null) ? 10 : prod1.CurrentPrice},
                new OrderDetail {Order = order, Product = prod2, Quantity = 2, UnitCost =  (prod2 == null) ? 10 : prod2.CurrentPrice},
                new OrderDetail {Order = order, Product = prod3, Quantity = 5, UnitCost = (prod3 == null) ? 10 : prod3.CurrentPrice},
            };
        }
            ...
            StoreContext context)
        {
            ...
            return new List<OrderDetail>
            {
                new OrderDetail {Product = prod1, Quantity = 3, UnitCost = (prod1 == null) ? 10 : prod1.CurrentPrice},
                new OrderDetail {Product = prod2, Quantity = 2, UnitCost = (prod2 == null) ? 10 : prod2.CurrentPrice},
                new OrderDetail {Product = prod3, Quantity = 5, UnitCost = (prod3 == null) ? 10 : prod3.CurrentPrice},
            };
        }
